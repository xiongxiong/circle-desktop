...
const IconXialajiantouxiao1: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
...
IconXialajiantouxiao1.defaultProps = {
  size: 18,
};

export default IconXialajiantouxiao1;
