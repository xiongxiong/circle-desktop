...
const IconHuafu: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
  const style = _style ? { ...DEFAULT_STYLE, ..._style } : DEFAULT_STYLE;

  return (
    <svg viewBox="0 0 1024 1024" width={size + 'px'} height={size + 'px'} style={style} {...rest}>
      <path
        d="M213.333333 213.333333l597.333334 0 0 597.333334-597.333334 0 0-597.333334Z"
...
IconHuafu.defaultProps = {
  size: 18,
};

export default IconHuafu;
